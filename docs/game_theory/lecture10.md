...
2. For an extensive form game $\mathcal G$, a profile of **behavior** strategies $b = (b_1, \cdots, b_n)$ for the players is called a **subgame perfect equilibrium (SGPE)** if it **defines a NE** **for *EVERY* subgame** of $\mathcal G$.
